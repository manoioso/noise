        ...
        <c:otherwise>
          ...
          <%
            ...
            <tr>
              ...
              <td> <% out.print( p.getCity()); %> </td>
             <td> <% out.print( p.getBroker()); %> </td>
              <td><a class="btn btn-success"> calculate shipment assurance</a>&nbsp;<a class="btn btn-danger" onclick="return confirm('Are you sure to delete this tracking history?')">Delete</a></td>
            </tr>
          <%} %>  
